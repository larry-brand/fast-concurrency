 ...
 */
public class FastLinkedBlockingQueue<E> extends AbstractQueue<E>
     ...
     */
    public FastLinkedBlockingQueue() {
     ...
     *         than zero
     */
    public FastLinkedBlockingQueue(int capacity) {
     ...
     */
    public FastLinkedBlockingQueue(Collection<? extends E> c) {
        this(Integer.MAX_VALUE);
        final ReentrantLock putLock = this.putLock;
